...
bool CollectionScene::Initialize()
{
	//	環境設定
...
void CollectionScene::Render()
{

#ifndef DEBUG_COLLECTION
	...
	// テキスト
	text->Draw(iexSystem::ScreenWidth / 2, iexSystem::ScreenHeight / 2, 0xff000000, "実績・トロフィー");
