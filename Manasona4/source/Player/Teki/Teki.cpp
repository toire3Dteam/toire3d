...
void Teki::InitActionDatas()
{
	...
	m_ActionDatas[(int)BASE_ACTION_STATE::RUSH2].pAttackData->pCollisionShape->pos.Set(7, 6.5, 0);
	...
	// 判定形状
	m_ActionDatas[(int)BASE_ACTION_STATE::HEAVEHO_DRIVE].pAttackData->pCollisionShape->width = 15;
...
void Teki::SkillAction::Land::Enter()
{
	...
	// てき自体の横幅を増やす
	m_pTeki->m_tagCharacterParam.HitSquare.width = 8.5f;
}
