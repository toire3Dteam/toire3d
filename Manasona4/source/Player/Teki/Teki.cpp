...
void Teki::InitActionDatas()
{
	...
	m_ActionDatas[(int)BASE_ACTION_STATE::SKILL].pAttackData->places[(int)AttackData::HIT_PLACE::AERIAL].hitStopFlame = 20;
	...
	// 判定形状
	m_ActionDatas[(int)BASE_ACTION_STATE::SKILL].pAttackData->pCollisionShape->width = 8;
	m_ActionDatas[(int)BASE_ACTION_STATE::SKILL].pAttackData->pCollisionShape->height = 10;
	m_ActionDatas[(int)BASE_ACTION_STATE::SKILL].pAttackData->pCollisionShape->pos.Set(36, 18, 0);

	//==============================================================================================================
	//	キャラクター固有下攻撃
	// 地上ヒットも空中ヒットも共通の情報
	m_ActionDatas[(int)BASE_ACTION_STATE::SKILL_SQUAT].InstanceAttackData();	// アタックデータ作成
	m_ActionDatas[(int)BASE_ACTION_STATE::SKILL_SQUAT].pAttackData->HitScore = 900;
	...
	m_ActionDatas[(int)BASE_ACTION_STATE::SKILL_SQUAT].pAttackData->places[(int)AttackData::HIT_PLACE::LAND].hitStopFlame = 8;
	m_ActionDatas[(int)BASE_ACTION_STATE::SKILL_SQUAT].pAttackData->places[(int)AttackData::HIT_PLACE::AERIAL].hitStopFlame = 10;
	...
	// 判定形状
	m_ActionDatas[(int)BASE_ACTION_STATE::SKILL_SQUAT].pAttackData->pCollisionShape->width = 10;
...
void Teki::InitMotionDatas()
{
	...
	m_iMotionNumbers[(int)MOTION_TYPE::AERIAL_DASH] = 28;
	m_iMotionNumbers[(int)MOTION_TYPE::PERSONA] = 19;
	m_iMotionNumbers[(int)MOTION_TYPE::CHARA_ATTACK_LAND] = 20;
	m_iMotionNumbers[(int)MOTION_TYPE::CHARA_ATTACK_SQUAT] = 20;
	m_iMotionNumbers[(int)MOTION_TYPE::CHARA_ATTACK_AERIAL] = 20;
	m_iMotionNumbers[(int)MOTION_TYPE::CHARA_ATTACK_AERIALDROP] = 20;
	m_iMotionNumbers[(int)MOTION_TYPE::HEAVEHO_DRIVE] = 21;
	m_iMotionNumbers[(int)MOTION_TYPE::BURST] = 35;
	m_iMotionNumbers[(int)MOTION_TYPE::HEAVEHO_DRIVE_OVERFLOW] = 22;
	m_iMotionNumbers[(int)MOTION_TYPE::THROW] = 23;
	m_iMotionNumbers[(int)MOTION_TYPE::THROW_SUCCESS] = 24;
	m_iMotionNumbers[(int)MOTION_TYPE::THROW_DRAW] = 25;
	m_iMotionNumbers[(int)MOTION_TYPE::UP_GUARD] = 26;
	m_iMotionNumbers[(int)MOTION_TYPE::DOWN_GUARD] = 27;
	m_iMotionNumbers[(int)MOTION_TYPE::ESCAPE] = 28;
	m_iMotionNumbers[(int)MOTION_TYPE::KNOCKBACK] = 29;
	m_iMotionNumbers[(int)MOTION_TYPE::KNOCKDOWN] = 30;
	m_iMotionNumbers[(int)MOTION_TYPE::KNOCKDOWN_DOWN] = 31;
	m_iMotionNumbers[(int)MOTION_TYPE::REVERSAL] = 32;
	m_iMotionNumbers[(int)MOTION_TYPE::APPEAR] = 33;
	m_iMotionNumbers[(int)MOTION_TYPE::WIN] = 34;
}
...
{
	// モーションに変える
	m_pTeki->SetMotion(MOTION_TYPE::CHARA_ATTACK_LAND);
...
bool Teki::SkillAction::Land::Execute()
{
	...
	if (m_pTeki->isHitAttack())
	{
		...
		m_pTeki->m_ActionDatas[(int)BASE_ACTION_STATE::SKILL].pAttackData->fComboRate = 1;
	}
...
{
	// アクションセット
	m_pTeki->SetActionState(BASE_ACTION_STATE::SKILL_SQUAT);

	// モーションセット
	m_pTeki->SetMotion(MOTION_TYPE::CHARA_ATTACK_SQUAT);
}
...
bool Teki::SkillAction::Squat::Execute()
{
	...
	{
		// 地上固有キャンセル
		if (!m_pTeki->isPushInput(PLAYER_COMMAND_BIT::DOWN)) SkillCancel(m_pTeki);
...
Teki::SkillAction::Aerial::Aerial(Teki *pTeki) :Base(pTeki, BASE_ACTION_STATE::SKILL_AERIAL)
{}

void Teki::SkillAction::Aerial::Enter()
{
	// モーションに変える
	m_pTeki->SetMotion(MOTION_TYPE::CHARA_ATTACK_AERIAL);
...
{
	// 攻撃情報を元に戻す
	memcpy_s(m_pTeki->m_ActionDatas[(int)BASE_ACTION_STATE::SKILL_AERIAL].pAttackData->pCollisionShape, sizeof(CollisionShape::Square), &m_OrgHitSquare, sizeof(CollisionShape::Square));
...
Teki::SkillAction::AerialDrop::AerialDrop(Teki *pTeki) :Base(pTeki, BASE_ACTION_STATE::SKILL_AERIALDROP), m_ActiveFrame(0)
{}

void Teki::SkillAction::AerialDrop::Enter()
{
	// モーションに変える
	m_pTeki->SetMotion(MOTION_TYPE::CHARA_ATTACK_AERIALDROP);
...
{
	// 攻撃情報を元に戻す
	memcpy_s(m_pTeki->m_ActionDatas[(int)BASE_ACTION_STATE::SKILL_AERIALDROP].pAttackData->pCollisionShape, sizeof(CollisionShape::Square), &m_OrgHitSquare, sizeof(CollisionShape::Square));

	m_pTeki->m_ActionDatas[(int)BASE_ACTION_STATE::SKILL_AERIALDROP].pAttackData->damage = m_OrgDamage;
	m_pTeki->m_ActionDatas[(int)BASE_ACTION_STATE::SKILL_AERIALDROP].pAttackData->places[(int)AttackData::HIT_PLACE::LAND].FlyVector = m_OrgFlyVector[(int)AttackData::HIT_PLACE::LAND];
	m_pTeki->m_ActionDatas[(int)BASE_ACTION_STATE::SKILL_AERIALDROP].pAttackData->places[(int)AttackData::HIT_PLACE::AERIAL].FlyVector = m_OrgFlyVector[(int)AttackData::HIT_PLACE::AERIAL];
	m_pTeki->m_ActionDatas[(int)BASE_ACTION_STATE::SKILL_AERIALDROP].pAttackData->fComboRate = m_fOrgComboRate;
}
