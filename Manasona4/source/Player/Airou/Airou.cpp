...
void Airou::InitAttackDatas()
{
	...
	m_AttackDatas[(int)BASE_ATTACK_STATE::RUSH1].FlyVector.Set(.1f, .1f);
	...
	m_AttackDatas[(int)BASE_ATTACK_STATE::RUSH1].FlyVector.Set(1.0f, .75f);
	m_AttackDatas[(int)BASE_ATTACK_STATE::RUSH3].pierceLV = 0;
	m_AttackDatas[(int)BASE_ATTACK_STATE::RUSH3].SE_ID = "通常3段";

	// 全共通
	FOR((int)BASE_ATTACK_STATE::END) m_AttackDatas[i].bHit = false;
}