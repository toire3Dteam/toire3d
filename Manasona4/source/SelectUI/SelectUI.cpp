...
SelectUI::SelectUI(SIDE side, ENTITY_ID id, int DeviceID, bool bAI) :BaseGameEntity(id)
{
	...
	for (int i = 0; i < (int)CHARACTER::END; i++)
	{
		...
		case CHARACTER::ARAMITAMA:
			m_tagCharaPic[i].pPic = new tdn2DAnim("Data/UI/CharacterSelect/Character/aramitama.png");
			m_tagCharaPicRip[i].pPic = new tdn2DAnim("Data/UI/CharacterSelect/Character/aramitama.png");
			m_tagCharaInfo[i].pPic = new tdn2DAnim("Data/UI/CharacterSelect/Info/aramitama.png");
			m_tagCharaName[i].pPic = new tdn2DAnim("Data/UI/CharacterSelect/name/aramitama.png");
			m_pCharaIconRip[i] = new tdn2DAnim("Data/UI/CharacterSelect/icon/aramitama.png");
			break;

		case CHARACTER::ANIKI:
			m_tagCharaPic[i].pPic = new tdn2DAnim("Data/UI/CharacterSelect/Character/aniki.png");
			m_tagCharaPicRip[i].pPic = new tdn2DAnim("Data/UI/CharacterSelect/Character/aniki.png");
			m_tagCharaInfo[i].pPic = new tdn2DAnim("Data/UI/CharacterSelect/Info/aniki.png");
			m_tagCharaName[i].pPic = new tdn2DAnim("Data/UI/CharacterSelect/name/aniki.png");
	...
	for (int i = 0; i < (int)PARTNER::END; i++)
	{
		...
		case PARTNER::ATTAKAI:
			m_tagPartnerPic[i].pPic = new tdn2DAnim("Data/UI/CharacterSelect/Partner/attakai.png");
			m_tagPartnerPicRip[i].pPic = new tdn2DAnim("Data/UI/CharacterSelect/Partner/attakai.png");
			m_tagPartnerInfo[i].pPic = new tdn2DAnim("Data/UI/CharacterSelect/Info/attakai.png");
			m_tagPartnerName[i].pPic = new tdn2DAnim("Data/UI/CharacterSelect/Name/attakai.png");
			m_tagPartneSirclePic[i].pPic = new tdn2DAnim("Data/UI/CharacterSelect/Partner/attakaiSircle.png");
