...
AirouWindow::~AirouWindow()
{

}


bool AirouWindow::Update()
{
	// 起動していなかったらハジく
...
// 操作
bool  AirouWindow::Ctrl(int DeviceID)
{
	// 起動していなかったらハジく
	if (m_bActive == false)return false;
